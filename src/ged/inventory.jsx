        ...
        switch (feature.feature) {
            ...
            case "Skill Mastery":
                ...
                if (feature.trainedSkill === "Macgyver") return [
                    [{ name: "Smith tools", itemType: "Equipment" }, { name: "Hammer and chisel", itemType: "Equipment" }, { name: "Carpenter tools", itemType: "Equipment" }, { name: "Apothecary tools", itemType: "Equipment"}],
            ...
            case "Special Ancestry":
                return [
                    [{ title: "Your people's favored weapon", table: tables.ALL_WEAPONS, itemType: "Weapon" }, { title: "Background tools for your people's favored profession", table: tables.BACKGROUNDS.map(bg => `${bg} tools`), itemType: "Equipment" }, { title: "A good luck trinket that reminds you of home", derpStored: true, table: tables.TRINKETS.map(trinket => `Good Luck ${trinket}`), itemType: "Trinket"}]
                ]
            case "Words of Power":
                return [
                    [{ name: "Staff", itemType: "Light Melee Weapon" }, { name: "Dagger", itemType: "Light Melee Weapon" }, { name: "Sling", itemType: "Ranged Weapon"}],
                    [{ name: "Librarian tools", itemType: "Equipment" }, { name: "Apothecary tools", itemType: "Equipment"}]
                ]
        }
    }
